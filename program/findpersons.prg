...
* Add the processing instruction node to the document.  
 ...
 oSearchQuery.appendChild(oXML.createElement("value")).text = 'Рябов'
 ...
 oSearchQuery.appendChild(oXML.createElement("cmp")).text   = 'EQ'
 oSearchQuery.appendChild(oXML.createElement("value")).text = 'Михаил'
 oRequest.appendChild(oSearchQuery)
 ...
 oSearchQuery.appendChild(oXML.createElement("cmp")).text   = 'EQ'
 oSearchQuery.appendChild(oXML.createElement("value")).text = 'Станиславович'
 oRequest.appendChild(oSearchQuery)
