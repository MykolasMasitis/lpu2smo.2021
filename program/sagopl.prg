PROCEDURE SagOpl
 ...
 SCAN
   ...
   *m.vozr = ROUND((m.tdat2 - m.dr)/365.25,2)
   ...
   m.tsum = m.tsum + s_all + IIF(FIELD('s_lek')='S_LEK', s_lek, 0)
 ...
 ENDSCAN 
 BROWSE 
 COPY TO &pout\&gcperiod\sagoplm00
 USE  
 ...
 ENDSCAN 
 BROWSE 
 COPY TO &pout\&gcperiod\sagoplm01
 USE  
 SELECT cursv2
 SCAN 
  m.tsum = tsum
 ...
 ENDSCAN 
 BROWSE 
 COPY TO &pout\&gcperiod\sagoplm02
 USE  
 SELECT cursv3
 SCAN 
  m.tsum = tsum
 ...
 ENDSCAN 
 BROWSE 
 COPY TO &pout\&gcperiod\sagoplm03
 USE  
