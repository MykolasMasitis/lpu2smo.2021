PROCEDURE SvodPr4St
 ...
 '(ВАРИАНТ 1)'+CHR(13)+CHR(10),4+32,'СТОМАТОЛОГИЯ')=7
  RETURN 
 ENDIF 
 ...
 *oExcel.Cells(2,5).Value  = 'Номер Договора с МО'
  ...
  *ENDIF 
  ...
  m.str08 = IIF(USED('mag'), mag.col17, 0) && aisoms.st_flk
 ...
 BookName = 'svpr4st'+m.qcod+PADL(DAY(DATE()),2,'0')+PADL(MONTH(DATE()),2,'0')
