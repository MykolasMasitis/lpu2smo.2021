...
FUNCTION MakePage3
 ...
 FOR m.nstr=1 TO 9
   ...
   *.Cells(13+m.nstr,9).Value  = TRANSFORM(dimdsp(m.nstr,4), '99999') && Изменено 18.04.2019
   .Cells(13+m.nstr,9).Value  = TRANSFORM(dimdsp(m.nstr,3), '99999')  && Изменено 18.04.2019
...
*   .Cells(13+m.nstr,12).Value = TRANSFORM(dimdsp(m.nstr,6), '99999')
   ...
   *.Cells(13+m.nstr,15).Value = TRANSFORM(dimdsp(m.nstr,10), '99999') && Изменено 18.04.2019
   .Cells(13+m.nstr,15).Value = TRANSFORM(dimdsp(m.nstr,9), '99999')   && Изменено 18.04.2019
