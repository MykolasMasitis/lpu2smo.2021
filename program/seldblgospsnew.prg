PROCEDURE seldblgospsnew
 IF MESSAGEBOX(CHR(13)+CHR(10)+'ÎÒÎÁÐÀÒÜ ÏÎÂÒÎÐÍÛÅ ÃÎÑÏÈÒÀËÈÇÀÖÈÈ?'+CHR(13)+CHR(10),4+32,'')=7
  RETURN 
 ENDIF 
...
*  SCATTER MEMVAR 
 ...
 IF USED('hopff')
  USE IN hopff
 ENDIF 
 m.dotname = ptempl+'\dblgospsnew.xls'
 m.docname = pmee+'\dblgosps'+m.qcod+PADL(DAY(DATE()),2,'0')+PADL(MONTH(DATE()),2,'0')
