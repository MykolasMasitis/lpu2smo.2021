PROCEDURE FormSh09
 IF MESSAGEBOX(CHR(13)+CHR(10)+'—¬≈ƒ≈Õ»ﬂ Œ —À”◊¿ﬂ’ Õ≈œ–Œ‘»À‹ÕŒ… √Œ—œ»“¿À»«¿÷»»'+CHR(13)+CHR(10)+;
 	'— Œ—“–€Ã  Œ–ŒÕ¿–Õ€Ã —»Õƒ–ŒÃŒÃ (I20,I21,I22,I24.8)?',4+32,'')=7
  RETURN 
 ENDIF 
...
*  ENDIF 
  ...
  SCAN 
   ...
   ENDIF 
   m.ds = ds
   IF !INLIST(m.ds, 'I20','I21','I22','I24.8')
    LOOP 
   ENDIF 
 ...
 SELECT crs 
 COPY TO pmee+'\SH09'+SUBSTR(m.gcperiod,3)
 ...
 m.dotname = ptempl+'\FormSh09.xls'
 m.docname = pmee+'\SH09'+SUBSTR(m.gcperiod,3)
