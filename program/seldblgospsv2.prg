PROCEDURE seldblgospsv2
 IF MESSAGEBOX(CHR(13)+CHR(10)+'ОТОБРАТЬ ПОВТОРНЫЕ ГОСПИТАЛИЗАЦИИ?'+CHR(13)+CHR(10),4+32,'ВЕРСИЯ 2')=7
  RETURN 
 ENDIF 
 ...
 FOR lnmonth=9 TO 12
  m.lcperiod = STR(tYear-1,4)+PADL(lnmonth,2,'0')
