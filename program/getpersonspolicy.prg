 ...
 * Create a procesing instruction.  
 ...
 oRequest = oXML.createElement("ser:getPersonsPolicyRequest")
 ...
 oXML.save('&curSoapDir\getPersonsPolicyRequest.xml')
 length = fso.GetFile("&curSoapDir\getPersonsPolicyRequest.xml").Size
...
* 	'ПРОШЛА УСПЕШНО!',0+64,'')
 ...
 oXML.save('&curSoapDir\getPersonsPolicyAnswer.xml')
