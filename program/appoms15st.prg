PROCEDURE AppOMS15st
 IF MESSAGEBOX(CHR(13)+CHR(10)+'«¿√–”«»“‹ ◊»—À≈ÕÕŒ—“‹ œ–» –≈œÀ≈Õ»ﬂ?', 4+32, '—“ŒÃ¿“ŒÀŒ√»ﬂ')=7
  RETURN 
 ENDIF 
 
 m.mmyy = PADL(tMonth,2,'0') + RIGHT(STR(tYear,4),2)
 flname = 'OMS15'+m.qcod+m.mmyy+'st.xls'
 ...
 CREATE CURSOR oms15st (lpuid n(4), paz_outs n(6), paz n(6), ch01m n(6), ch01f n(6), ch14m n(6), ch14f n(6), ch514m n(6), ch514f n(6), ;
 ...
 IF m.err = .t. 
  USE IN oms15st
  MESSAGEBOX('Õ≈ ”ƒ¿ÀŒ—‹ Œ“ –€“‹ ‘¿…À!'+CHR(13)+CHR(10)+oEx.Message, 0+64, 'Excel')
  RETURN .F.
 ENDIF 
 ...
 *USE 
 ...
 IF OpenFile(pcommon+'\pnorms', 'pnorm', 'shar', 'period')>0
  IF USED('pnorm')
   USE IN pnorm
  ENDIF 
  USE IN aisoms
 ...
 SCAN
  ...
  m.pazvals = oms15st.ch01m+oms15st.ch01f+oms15st.ch14m+oms15st.ch14f+;
 	oms15st.ch514m+oms15st.ch514f+oms15st.ch1517m+oms15st.ch1517f+;
 	oms15st.m1824+oms15st.f1824+oms15st.m2534+oms15st.f2534+;
 	oms15st.m3544+oms15st.f3544+oms15st.m4559+oms15st.f4559+;
 	oms15st.m6068+oms15st.f5564+oms15st.m69+oms15st.f65

  m.finvals = oms15st.ch01m*m.m0001 + oms15st.ch01f*m.f0001 + oms15st.ch14m*m.m0104 + oms15st.ch14f*m.f0104 + ;
  	oms15st.ch514m*m.m0514 + oms15st.ch514f*m.f0514 + oms15st.ch1517m*m.m1517 + oms15st.ch1517f*m.f1517 + ;
  	oms15st.m1824*m.m1824 + oms15st.f1824*m.f1824 + oms15st.m2534*m.m2534 + oms15st.f2534*m.f2534 + ;
  	oms15st.m3544*m.m3544 + oms15st.f3544*m.f3544 + oms15st.m4559*m.m4559 + oms15st.f4559*m.f4554 + ;
  	oms15st.m6068*m.m6068 + oms15st.f5564*m.f5564 + oms15st.m69*m.m6999 + oms15st.f65*m.f6599
