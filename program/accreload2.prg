FUNCTION  AccReload2(lcmcod, lnlpuid, para8)
 m.mcod  = lcmcod
 m.lpuid = lnlpuid
...
FUNCTION CreateFilesStructure
 ...
 CREATE TABLE (Error) (f c(1), c_err c(3), detail c(1), rid i, tip n(1), dt t, usr c(6), "comment" c(250))
 ...
 CREATE TABLE (mError) ;
  (rid i autoinc, RecId i, cod n(6), k_u n(4), tip c(1), et c(1), ee c(1), usr c(6), d_exp d,;
   ...
   subet n(1), reason c(1), n_akt c(15), t_akt c(2), d_edit d)
